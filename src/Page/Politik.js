...
const urlEverything = 'https://newsapi.org/v2/everything?q=politic&apiKey=7bd9771f997e43a4880691db83cb5221'

class Politik extends Component {
    constructor(props){
        super(props);
        this.state = {
            popularNews:[],
    ...
    render() {
        ...
        return (
            <div className='App'>
                <NavbarNews/>
                <br/>
                <h1 style= {{textAlign: 'center', marginTop: '30px'}}>POLITIK</h1>
                <br/>
                <div class="container">
                <div class="row">
                    <div class="col-md-4">
