...
const urlEverything = 'https://newsapi.org/v2/everything?q=ekonomi&apiKey=7bd9771f997e43a4880691db83cb5221'
    ...
    render() {
        ...
        return (
            <div className='App'>
                <NavbarNews/>
                <br/>
                <h1 style= {{textAlign: 'center', marginTop: '30px'}}>EKONOMI</h1>
                <br/>
                <div class="container">
                <div class="row">
                    <div class="col-md-4">
